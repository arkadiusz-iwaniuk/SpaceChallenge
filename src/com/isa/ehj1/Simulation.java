...
public class Simulation {
    ...
    int runSimulation(ArrayList<Rocket> list) {
        ...
        System.out.println(list.size() + " rockets and " + crash + " extra trials = "
                + (list.size() + crash) + " in total");
        return budget;
    }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        ArrayList<Item> phase1 = sim.loadItems("src/Phase-1.txt");
        ArrayList<Item> phase2 = sim.loadItems("src/Phase-2.txt");
